    ...
    <div className="routes-page">
      <section className="routes-section">
        ...
        {isLoading ? (
          ...
          <div className="routes-table-wrapper" style={{ maxWidth: '1000px' }}>
        ...
        {isFormOpen && (
          <div className="routes-section" id="horario-form-section" style={{ maxWidth: '1000px', marginTop: '1.25rem', background: 'var(--panel-bg)', borderRadius: '0.75rem', padding: '1.25rem' }}>
